...
INSERT INTO genre VALUES ('Hip-Hop'), ('Klassik');
SELECT *FROM titel;
SELECT *FROM genre;
SELECT *FROM interpret;

INSERT INTO titel (titel, interpretID, genreID) VALUES 
('Satisfaction',1, 1),
('Start Me Up',1, 1),
('Paint It Black',1, 1),
...
('Nardis', 3, 3),
('Lose Yourself', 4, 6),
('The Real Slim Shady', 4, 6),
('Without Me', 4, 6),
('Mockingbird', 4, 6),
('Stan', 4, 6),
('Symphonie Nr. 5', 5, 7),
('Für Elise', 5, 7),
('Mondscheinsonate', 5, 7),
('Ode an die Freude', 5, 7),
('Harder Better Faster Stronger', 6, 4),
('One More Time', 6, 4),
('Digital Love', 6, 4),
('Robot Rock', 6, 4),
('Get Lucky', 6, 4),
('Around the World', 6, 4),
('Technologic', 6, 4),
('No Woman No Cry', 7, 5),
('Three Little Birds', 7, 5),
('Redemption Song', 7, 5),
('Jamming', 7, 5),
('Could You Be Loved', 7, 5),
('Viva La Vida', 8, 2),
('Paradise', 8, 2),
('Fix You', 8, 2),
('The Scientist', 8, 2),
...
--teil2 daten Veranstaltung
INSERT INTO inVer (z_i_nr, z_v_nr, datum_von, datum_bis) VALUES
